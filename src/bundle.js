...
var LoginPage = ({ onNavigateRegister, onLoginSuccess }) => {
  ...
  return /* @__PURE__ */ React20.createElement("div", { style: { display: "flex", minHeight: "100vh", width: "100vw", background: isDark ? "#090a0d" : "#141518", overflowX: "hidden" } }, /* @__PURE__ */ React20.createElement(
    "div",
    {
      style: {
        width: "50%",
...
var RegisterPage = ({ onNavigateLogin, onRegisterSuccess }) => {
  ...
  return /* @__PURE__ */ React21.createElement("div", { style: { display: "flex", minHeight: "100vh", width: "100vw", background: isDark ? "#090a0d" : "#141518", overflowX: "hidden" } }, /* @__PURE__ */ React21.createElement(
    "div",
    {
      style: {
        width: "50%",
